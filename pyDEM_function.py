...
def get_file_names(file_path, file_type='.tif'):
    '''Get the name of one type of files in a folder.

    Parameters:
        file_path <str> -- The path of a folder.
        file_type <str> -- The type of files. Default='.tif'.

    Return:
        file_names <list> -- The name of files with extension (e.g., ['***_dem.tif', ...]).
    '''
    file_names = []
...
def get_dem_info(dem_data, if_print=0):
    '''Get the information of DEM.

    Parameters:
        dem_data <osgeo.gdal.Dataset> -- The data of DEM.
        if_print <int> -- If print the information of DEM. Default=0 (not print).
...
def write_dem(d_path, d_array, d_row, d_col, d_band, d_gt, d_proj, d_type=gdal.GDT_UInt16, d_frmt='GTiff'):
    ...
    Parameters:
        ...
        d_type -- The data type of new DEM. Default=gdal.GDT_UInt16.
        d_frmt -- The data format of new DEM. Default='GTiff'.
...
def show_2d_dem(dem_path, dem_name, img_path, img_name, img_frmt='.png', img_size=(5, 10)):
    ...
    Parameters:
        ...
        img_frmt <str> -- The format of image. Default='.png'.
        img_size <tuple> -- The size of image. Default=(5, 10).

    Return:
        0 <int> -- If display and saving tasks are completed.
    '''
