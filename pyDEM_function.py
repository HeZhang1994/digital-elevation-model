...
def get_file_names(file_path, file_type='.tif'):
    ...
    Parameters:
        ...
        file_type <str> -- The type of files. Default is '.tif'.
...
def get_dem_info(dem_data, if_print=0):
    ...
    Parameters:
        ...
        if_print <int> -- If print the information of DEM. Default is 0 (not print).
...
def write_dem(d_path, d_array, d_row, d_col, d_band, d_gt, d_proj, d_type=gdal.GDT_UInt16, d_frmt='GTiff'):
    ...
    Parameters:
        ...
        d_type -- The data type of new DEM. Default is gdal.GDT_UInt16.
        d_frmt -- The data format of new DEM. Default is 'GTiff'.
